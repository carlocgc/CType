...
namespace Type.Objects.Bosses
{
    ...
    /// </summary>
    public sealed class BossStation : GameObject, IBoss, IEnemyListener
    {
        ...
        public BossStation()
        {
            ...
            _Cannons.Add(new BossCannon(50, TimeSpan.FromMilliseconds(1500)) { Offset = new Vector2(250, 195) });
            _Cannons.Add(new BossCannon(50, TimeSpan.FromMilliseconds(1500)) { Offset = new Vector2(-205, 195) });
            _Cannons.Add(new BossCannon(75, TimeSpan.FromMilliseconds(1200)) { Offset = new Vector2(10, 195) });
            _Cannons.Add(new BossCannon(100, TimeSpan.FromMilliseconds(1000)) { Offset = new Vector2(8, 60) });
            _Cannons.Add(new BossCannon(75, TimeSpan.FromMilliseconds(1200)) { Offset = new Vector2(10, -110) });
            _Cannons.Add(new BossCannon(50, TimeSpan.FromMilliseconds(1500)) { Offset = new Vector2(250, -110) });
            _Cannons.Add(new BossCannon(50, TimeSpan.FromMilliseconds(1500)) { Offset = new Vector2(-205, -110) });
