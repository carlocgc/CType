...
{
    /// <summary>
    /// Creates movement in an elipse while increasing Y axis
    /// </summary>
    public class EllipseIncreaseMotion : IAccelerationProvider
    {
        ...
        public EllipseIncreaseMotion(Vector2 direction, Single speed)
        {
